...
export default function Toast({ message, type = 'info', duration = 3000, onClose }) {
  ...
  return (
    <div className="fixed top-6 right-6 z-[9999] pointer-events-none">
      <div className={`flex items-start gap-3 p-4 rounded-lg border ${bgColor} backdrop-blur-sm animate-in fade-in slide-in-from-top-2 duration-300 pointer-events-auto max-w-sm shadow-lg`}>
